...
def login2():
    ...
    if request.method == 'POST':
        ...
        if user :
            ...
            discord_log_login(f"Login 2 == {client_ip} just logged in with '{username}' Device ```{user_agent}``` <@709799648143081483>")
...
def english():
  teacher_links = {
     "Hossam Sameh": ("english/hossamsameh", "Lw 7d 3ndo rev2 mafto7ha text pls" ),
