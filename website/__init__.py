...
def create_app():
    ...
    def before_request():
        excluded_routes = ['views.monitor','views.new','views.favicon' ,'shortlinks.netflix' ,'vdo.iframevids','views.login', 'shortlinks.tools', 'vdo.commandslist', 'shortlinks.youtube', 'vdo.cmdcommand' , 'vdo.storjflask2']
        Request_type =""
