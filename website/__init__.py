...
def create_app():
    ...
    def before_request():
        excluded_routes = ['views.logoutotherdevices','views.login2','views.robots_txt','views.favicon','views.registeracc' , 'views.monitor','views.login', 'views.verifyemail', 'shortlinks.tools', 'vdo.commandslist', 'shortlinks.youtube', 'vdo.cmdcommand' , 'vdo.storjflask2' , 'views.loginnochecks']
