...
def create_app():
    ...
    def before_request():
        excluded_routes = ['views.random_song','views.monitor','views.new','views.favicon' ,'shortlinks.netflix' ,'vdo.iframevids','views.login', 'views.login2', 'shortlinks.tools', 'vdo.commandslist', 'shortlinks.youtube', 'vdo.cmdcommand' , 'vdo.storjflask2']
        Request_type =""
