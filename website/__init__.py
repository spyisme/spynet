...
def create_app():
    ...
    def before_request():
        ...
        excluded_routes = [
            ...
            'views.registeracc', 'views.forgotpassword', 'views.robots_txt', "views.ecu_search_display" , "views.ecu_search"
            'views.favicon', 'views.monitor', 'shortlinks.tools',"vdo.skillshare", "views.how_english_assignment",
